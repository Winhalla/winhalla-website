...
function create_else_block(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(h2, file, 41, 12, 2344);
    },
...
function create_if_block(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      attr_dev(h2, "class", "text-center text-3xl font-bold pt-4");
      add_location(h2, file, 39, 12, 2254);
    },
    m: function mount(target, anchor) {
      insert_dev(target, h2, anchor);
      append_dev(h2, t);
...
function create_fragment(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      attr_dev(div0, "class", "loader svelte-lb6vy7");
      add_location(div0, file, 37, 8, 2194);
      attr_dev(div1, "class", "pb-20");
      add_location(div1, file, 36, 4, 2165);
      attr_dev(div2, "class", "h-screen-90 bg-fixed bg-no-repeat flex items-center justify-center");
      add_location(div2, file, 35, 0, 2079);
    },
    m: function mount(target, anchor) {
