import { _ as _inherits, a as _getPrototypeOf, b as _possibleConstructorReturn, c as _classCallCheck, i as init, d as _assertThisInitialized, e as dispatch_dev, S as SvelteComponentDev, s as safe_not_equal, g as space, f as element, t as text, q as query_selector_all, k as detach_dev, l as claim_space, j as claim_element, m as children, n as claim_text, p as add_location, o as attr_dev, u as insert_dev, r as append_dev, K as set_input_value, L as listen_dev, C as _slicedToArray, M as prop_dev, v as noop, N as run_all, D as onMount, w as validate_slots, F as callApi, H as goto, E as counter, y as _asyncToGenerator, z as regenerator } from './client.638e0a89.js';
...
var file = "src\\routes\\change-email.svelte"; // (61:4) {:else}
...
function create_fragment(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(h2, file, 55, 4, 2503);
      attr_dev(input, "size", "100");
      attr_dev(input, "id", "test");
      attr_dev(input, "class", "text-black p-1");
      add_location(input, file, 56, 4, 2523);
      add_location(br, file, 64, 4, 2772);
      button.disabled = button_disabled_value = !
      /*valid*/
      ctx[1];
      attr_dev(button, "class", "px-4 py-1 mt-4 bg-primary rounded svelte-zk8yyq");
      add_location(button, file, 65, 4, 2784);
      attr_dev(div, "class", "p-8");
      add_location(div, file, 54, 0, 2480);
    },
    m: function mount(target, anchor) {
