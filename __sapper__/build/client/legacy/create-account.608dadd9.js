...
function create_else_block(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(h1, file, 334, 20, 14544);
      attr_dev(div0, "class", "text-center mt-7 lg:mt-12");
      add_location(div0, file, 333, 16, 14483);
      attr_dev(p0, "class", "text-6xl mt-6");
      add_location(p0, file, 344, 24, 15001);
      attr_dev(b0, "class", "svelte-11ro173");
      add_location(b0, file, 347, 28, 15154);
      attr_dev(b1, "class", "svelte-11ro173");
      add_location(b1, file, 349, 28, 15231);
      attr_dev(b2, "class", "svelte-11ro173");
      add_location(b2, file, 351, 28, 15312);
      add_location(u0, file, 353, 28, 15401);
      attr_dev(b3, "class", "svelte-11ro173");
      add_location(b3, file, 355, 28, 15476);
      attr_dev(p1, "class", "leading-7 mt-13");
      add_location(p1, file, 345, 24, 15059);
      attr_dev(div1, "class", "card py-8 px-6 text-center w-64 h-78 mb-6 md:mb-0\r\n                        md:mr-12");
      add_location(div1, file, 341, 20, 14853);
      attr_dev(path0, "d", "m19.2 2.43-2.422-2.43-11.978 12 11.978 12\r\n                                    2.422-2.43-9.547-9.57z");
      add_location(path0, file, 365, 32, 15986);
      attr_dev(svg0, "class", "w-4 fill-current text-accent -mr-3");
      attr_dev(svg0, "viewBox", "0 0 24 24");
      attr_dev(svg0, "xmlns", "http://www.w3.org/2000/svg");
      add_location(svg0, file, 361, 28, 15750);
      attr_dev(div2, "class", "h-2px bg-accent w-40");
      add_location(div2, file, 369, 28, 16203);
      attr_dev(path1, "d", "m4.8 21.57 2.422 2.43\r\n                                    11.978-12-11.978-12-2.422 2.43 9.547 9.57z");
      add_location(path1, file, 374, 32, 16505);
      attr_dev(svg1, "class", "w-4 fill-current text-accent -ml-3");
      attr_dev(svg1, "viewBox", "0 0 24 24");
      attr_dev(svg1, "xmlns", "http://www.w3.org/2000/svg");
      add_location(svg1, file, 370, 28, 16269);
      attr_dev(div3, "class", "hidden md:flex items-center");
      add_location(div3, file, 360, 24, 15679);
      attr_dev(path2, "d", "m21.57 19.2 2.43-2.422-12-11.978-12\r\n                                    11.978 2.43 2.422 9.57-9.547z");
      add_location(path2, file, 384, 32, 17066);
      attr_dev(svg2, "class", "w-4 fill-current text-accent -mb-3");
      attr_dev(svg2, "viewBox", "0 0 24 24");
      attr_dev(svg2, "xmlns", "http://www.w3.org/2000/svg");
      add_location(svg2, file, 380, 28, 16830);
      attr_dev(div4, "class", "w-2px bg-accent h-16");
      add_location(div4, file, 388, 28, 17284);
      attr_dev(path3, "d", "m2.43 4.8-2.43 2.422 12 11.978\r\n                                    12-11.978-2.43-2.422-9.57 9.547z");
      add_location(path3, file, 393, 32, 17586);
      attr_dev(svg3, "class", "w-4 fill-current text-accent -mt-3");
      attr_dev(svg3, "viewBox", "0 0 24 24");
      attr_dev(svg3, "xmlns", "http://www.w3.org/2000/svg");
      add_location(svg3, file, 389, 28, 17350);
      attr_dev(div5, "class", "flex flex-col md:hidden items-center");
      add_location(div5, file, 379, 24, 16750);
      attr_dev(p2, "class", "text-center text-extra-light text-lg ml-4\r\n                            md:ml-0");
      add_location(p2, file, 399, 24, 17832);
      attr_dev(div6, "class", "flex items-center md:block");
      add_location(div6, file, 359, 20, 15613);
      attr_dev(p3, "class", "text-6xl");
      add_location(p3, file, 408, 24, 18223);
      attr_dev(b4, "class", "svelte-11ro173");
      add_location(b4, file, 411, 28, 18379);
      add_location(u1, file, 413, 28, 18467);
      attr_dev(b5, "class", "svelte-11ro173");
      add_location(b5, file, 415, 28, 18551);
      attr_dev(b6, "class", "svelte-11ro173");
      add_location(b6, file, 417, 28, 18630);
      attr_dev(p4, "class", "leading-7 mt-4");
      add_location(p4, file, 409, 24, 18284);
      attr_dev(div7, "class", "card py-8 px-6 text-center w-64 h-78 mt-6 lg:mt-0\r\n                        md:ml-12");
      add_location(div7, file, 405, 20, 18075);
      attr_dev(div8, "class", "flex flex-col md:flex-row items-center");
      add_location(div8, file, 340, 16, 14779);
      attr_dev(p5, "class", "leading-none");
      add_location(p5, file, 427, 24, 19062);
      ...
      add_location(path4, file, 433, 28, 19405);
      ...
      add_location(path5, file, 447, 28, 20337);
      attr_dev(svg4, "class", "fill-current text-primary w-10 md:w-5 ml-1\r\n                            lg:ml-4 lg:block");
      attr_dev(svg4, "viewBox", "0 0 24 24");
      attr_dev(svg4, "xmlns", "http://www.w3.org/2000/svg");
      add_location(svg4, file, 428, 24, 19131);
      attr_dev(button, "class", "text-background bg-font py-4 px-4 mt-14 flex items-center rounded svelte-11ro173");
      add_location(button, file, 425, 20, 18929);
      attr_dev(div9, "class", "lg:flex justify-center");
      add_location(div9, file, 422, 16, 18788);
      attr_dev(b7, "class", "accent svelte-11ro173");
      add_location(b7, file, 455, 20, 20801);
      attr_dev(b8, "class", "accent svelte-11ro173");
      add_location(b8, file, 457, 20, 20897);
      attr_dev(p6, "class", "pt-4 text-lg text-center");
      add_location(p6, file, 453, 16, 20702);
      attr_dev(a, "href", a_href_value = "" + (apiUrl + "/auth/redirect-after-account"));
      attr_dev(a, "class", "button button-brand mt-10 block mx-auto mb-6 md:mb-0");
      add_location(a, file, 460, 16, 20994);
      attr_dev(div10, "class", "flex flex-col items-center px-5");
      add_location(div10, file, 332, 12, 14420);
    },
...
function create_if_block(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(h1, file, 201, 20, 7792);
      attr_dev(div0, "class", "text-center md:text-left mt-7 md:mt-12");
      add_location(div0, file, 200, 16, 7718);
      attr_dev(p0, "class", "input-header svelte-11ro173");
      add_location(p0, file, 208, 20, 8064);
      attr_dev(input0, "type", "email");
      attr_dev(input0, "placeholder", "Your email goes here");
      attr_dev(input0, "class", "input-style focus:outline-none\r\n                            focus:border-primary placeholder-disabled svelte-11ro173");
      toggle_class(input0, "border-legendary",
      /*validEmail*/
      ctx[3] == false);
      add_location(input0, file, 210, 24, 8150);
      add_location(div1, file, 209, 20, 8119);
      attr_dev(div2, "class", "md:mt-4");
      add_location(div2, file, 207, 16, 8021);
      attr_dev(p1, "class", "text-3xl input-header svelte-11ro173");
      add_location(p1, file, 238, 20, 9606);
      attr_dev(input1, "placeholder", "Paste here your affiliate link");
      attr_dev(input1, "class", "input-style focus:outline-none\r\n                            focus:border-primary w-full placeholder-disabled svelte-11ro173");
      toggle_class(input1, "border-legendary",
      /*validLink*/
      ctx[2] == false);
      add_location(input1, file, 240, 24, 9707);
      add_location(div3, file, 239, 20, 9676);
      attr_dev(div4, "class", "mt-4");
      toggle_class(div4, "mt-12",
      /*validEmail*/
      ctx[3] == null);
      add_location(div4, file, 237, 16, 9533);
      button.disabled = button_disabled_value = !
      /*validEmail*/
      ctx[3];
      attr_dev(button, "class", "button button-brand mt-3 svelte-11ro173");
      toggle_class(button, "mt-11",
      /*validLink*/
      ctx[2] == null);
      add_location(button, file, 264, 16, 11053);
      attr_dev(div5, "class", "flex flex-col justify-center px-5 md:p-0");
      add_location(div5, file, 199, 12, 7646);
    },
    m: function mount(target, anchor) {
...
function create_if_block_4(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      attr_dev(p, "class", "text-legendary info  svelte-11ro173");
      add_location(p, file, 232, 28, 9381);
    },
    m: function mount(target, anchor) {
...
function create_if_block_3(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(path, file, 225, 36, 8974);
      attr_dev(svg, "class", "fill-current text-green w-4 check svelte-11ro173");
      attr_dev(svg, "viewBox", "0 0 33 24");
      attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
      add_location(svg, file, 221, 32, 8723);
      attr_dev(p, "class", "text-green info svelte-11ro173");
      add_location(p, file, 229, 32, 9217);
      attr_dev(div, "class", "flex items-center");
      add_location(div, file, 220, 28, 8658);
    },
    m: function mount(target, anchor) {
...
function create_if_block_2(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      attr_dev(p, "class", "text-legendary info svelte-11ro173");
      add_location(p, file, 260, 28, 10905);
    },
    m: function mount(target, anchor) {
      insert_dev(target, p, anchor);
      append_dev(p, t);
...
function create_if_block_1(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      attr_dev(path, "d", "m0 10.909 4.364-4.364 8.727 8.727\r\n                                        15.273-15.273 4.364 4.364-19.636 19.636z");
      add_location(path, file, 253, 36, 10500);
      attr_dev(svg, "class", "fill-current text-green w-4 check svelte-11ro173");
      attr_dev(svg, "viewBox", "0 0 33 24");
      attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
      add_location(svg, file, 249, 32, 10249);
      attr_dev(p, "class", "text-green info svelte-11ro173");
      add_location(p, file, 257, 32, 10743);
      attr_dev(div, "class", "flex items-center");
      add_location(div, file, 248, 28, 10184);
    },
    m: function mount(target, anchor) {
      insert_dev(target, div, anchor);
      append_dev(div, svg);
...
function create_fragment(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(meta, file, 191, 4, 7332);
      attr_dev(div0, "class", "flex items-center justify-center md:h-screen-7");
      add_location(div0, file, 197, 4, 7531);
      add_location(div1, file, 196, 0, 7520);
    },
    m: function mount(target, anchor) {
