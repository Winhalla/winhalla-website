...
var removeBlobs = function removeBlobs(data, callback) {
  function _removeBlobs(obj, curKey, containingObject) {
    ...
    } else if (_typeof(obj) === 'object' && !isBuffer(obj)) {
      // and object
      for (var key in obj) {
...
function create_fragment(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(div, file, 14, 0, 300);
    },
