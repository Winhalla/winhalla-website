...
function create_fragment(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      add_location(button0, file, 32, 4, 619);
      add_location(button1, file, 33, 4, 671);
      add_location(div, file, 31, 0, 608);
    },
