        ...
        <div class="pb-3 lg:p-0 sm:flex items-center w-full justify-between">
                ...
                <a
                    ...
                    <svg
                        ...
                        xmlns="http://www.w3.org/2000/svg"><path
                            d="m10 12v8h-4v-8zm6-8v16h-4v-16zm16 18v2h-32v-24h2v22zm-10-14v12h-4v-12zm6-6v18h-4v-18z" /></svg>
                    PROFILE
                </a>
                <a
                    class="nav-link-container lg:hover:text-shadow-link-hover
                    ...
                    <svg
                        ...
                        viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg"><path
                            d="m.001 1.165v21.669c.052.661.601 1.177 1.271 1.177.225 0 .436-.058.62-.16l-.006.003 21.442-10.8c.4-.192.671-.593.671-1.058s-.271-.867-.664-1.055l-.007-.003-21.442-10.8c-.177-.099-.388-.157-.613-.157-.672 0-1.223.521-1.27 1.181v.004z" /></svg>
                    PLAY
                </a>
                <a
                    class="nav-link-container lg:hover:text-shadow-link-hover
            ...
            <div class="ml-7 mt-5 md:m-0 md:mr-7">
                ...
                {:else}
                    ...
                    <a class="button-brand-alternative button" href="/login">
                        LOGIN
                    </a>
                {/if}
            </div>
