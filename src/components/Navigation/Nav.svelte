...
<nav
    ...
    class="shadow-link-hover fixed z-50 lg:flex items-center bg-background
    text-font w-full transition duration-300 border-b border-transparent">
    {#if offline}
                ...
                <svg
                    ...
                    {:else}
                        <path
                            ...
                            9.6-9.6 9.6 2.4 2.4 9.6-9.6 9.6 9.6 2.4-2.4-9.6-9.6z" />
                    {/if}
                </svg>
            </button>
        </div>
                ...
                <a
                    ...
                    <svg
                        ...
                        <path
                            ...
                            .432.118.549.296l.002.002c.028.041 1.342 1.92 5.15
                            2.74-1.273-.64-2.518-1.529-2.847-2.673-.049-.187-.077-.401-.077-.622
                            0-.761.334-1.443.862-1.91l.003-.002c.425-.515
                            1.05-.851 1.755-.888h.006c1.714 0 2.904 2.391 3.583
                            4.309.749-1.87 2.037-4.252 3.74-4.252.741.039
                            1.388.41 1.799.966l.005.006c.48.464.779 1.113.779
                            1.832 0 .262-.04.515-.113.753l.005-.018c-.352
                            1.035-1.466 1.823-2.653 2.391 3.472-.872 4.675-2.61
