    ...
    <div class="daily-container ml-5 mr-5 md:ml-10 md:mr-10 lg:ml-0 lg:mr-8">
        <div class="flex relative">
            ...
            <div class="flex items-end ml-4">
                <div class="py-2 px-2 rounded-full tip-button bg-primary">
                    <svg
            ...
            <p class="absolute bg-primary text-lg py-4 px-5 rounded tip-text">
                Quests may take up to 30 minutes to refresh
            </p>
            <svg
                class="w-6 absolute tip-carret fill-current text-primary"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"><path
                    d="m0 6.4 12 12 12-12z" /></svg>
        </div>
