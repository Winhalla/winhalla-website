...
<div class="h-full px-100 pt-30 " style="font-family: Helvetica Neue,Helvetica,Arial,sans-serif; width:calc(99vw + 2px);">
    ...
    <p>All your account data is kept until you <a href="https://winhalla.app/deleteAccount">delete your account</a> and may be processed by our servers to provide the Service in its entirety</p>
    ...
    <p>Upon your first visit on the Site, we will ask for your consent regarding (among others) analytical software. You
        can edit your consent following <a href="#edit_consent">this</a> instructions</p>
    ...
    <p>We are using google adsense, because a website doesn't update and hosts itself!</p>
    <p>You can choose to enable or disable ad personalization via cookies on your first visit (you can always edit your
        consent <a href="#edit_consent">here</a>). Disabling ad personalisation still deposits cookies, but these are
    ...
    <ul>
        ...
        <li>Functionalities : used - among others - to determine if new notifications/alerts has arrived, these are not
            required, however they will have a major impact on your experience
        </li>
        <li>Analytical : as said <a href="#analytical">here</a>, they are not required an can be disabled</li>
        <li>Advertising cookies : as said <a href="#advertising">here</a> they are not required and can be disabled,
            however you
    ...
    <h2 id="edit_consent">V. Edit your consent</h2>
    <!--TODO-->

    <h2>VI. Changes to This Privacy Policy</h2>
    <p>We may update our Privacy Policy from time to time. Thus, we advise you to review this page periodically for any changes. We will notify you of any changes by posting the new Privacy Policy on this page and notifying of these change in the Site. These changes are effective immediately, after they are posted on this page.</p>
