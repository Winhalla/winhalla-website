...
<style>
    ...
    .shop-item::after {
        ...
        background: linear-gradient(
                ...
                rgba(23, 23, 26, 0.6) 0%,
                rgba(23, 23, 26, 0.75),
                rgba(23, 23, 26, 0.81) 75%,
                rgba(23, 23, 26, 0.90) 100%
        );
    }
                    ...
                    <div>
                        ...
                        <!--<div class="pt-8 lg:pt-16">
                            <div class="flex justify-center lg:justify-start items-center">
                                ...
                                <img class="hidden sm:block  w-24 -ml-2 -mt-2" src="/assets/Paypal_Logo.png" alt="">
                            </div>


                            <div class="mx-5 sm:mx-auto lg:mx-0  bg-variant max-w-max rounded-xl  p-8 relative  mt-6 md:mt-10">
                                ...
                                <p class="mt-4">You need to have a <a href="https://www.paypal.com/" class="text-primary">Paypal account</a></p>
                        ...
                        <div class="pt-8 lg:pt-16">
                            ...
                            <div class="flex mt-8 flex-wrap" style="width: 66%">
                                <div class="relative  shop-item">
                                    <img class="w-96" src="/assets/PaypalCards/base.png" alt="">
                                    <!---->
                                    <div class="w-full  flex justify-between px-4 items-center absolute bottom-4  z-10">
                                        <p class="text-3xl"><b class="font-normal text-primary text-5xl  mr-1">2.5$</b>
                                            PayPal Credit</p>
                                        <div class=""
                                        >
                                            <button
                                                ...
                                                <div class="flex  items-center  text-2xl">
                                                    <b
                                                            class="mr-2 font-normal"
                                                            style="padding-top: 0.12rem">16000</b>
                                                    <div class="w-8 mt-1 text-font"
                                                         style="margin-top: 0.25rem; margin-bottom: 0.35rem">
                                                        <CoinIcon/>
                                                    </div>
                                ...
                                <!--<div class="relative  shop-item  ml-12">
                                    <img class="w-96" src="/assets/PaypalCards/base.png" alt="">
                                    &lt;!&ndash;&ndash;&gt;
                                    <div class="w-full  flex justify-between px-4 items-center absolute bottom-4  z-10">
                                        <p class="text-3xl"><b class="font-normal text-primary text-5xl  mr-1">5$</b>
                                            PayPal Credit</p>
                                        <div class=""
                                        >
                                            <button
                                                ...
                                                <div class="flex  items-center  text-2xl">
                                                    <b
                                                            class="mr-2 font-normal"
                                                            style="padding-top: 0.12rem">30000</b>
                                                    <div class="w-8 mt-1 text-font"
                                                         style="margin-top: 0.25rem; margin-bottom: 0.35rem">
                                                        <CoinIcon/>
                                                    </div>
                                ...
                                <div class="relative  shop-item  ml-12  ">
                                    ...
                                    <!---->
                                    <div class="w-full  flex justify-between px-4 items-center absolute bottom-4  z-10">
                                        <p class="text-3xl"><b class="font-normal text-primary text-5xl  mr-1">

                                            10$</b> PayPal Credit</p>
                                        <div class=""
                                        >
                                            <button
                                                    disabled={!!featuredItem.unBuyable}
                                                ...
                                                <div class="flex  items-center  text-2xl">
                                                    <b
                                                            class="mr-2 font-normal"
                                                            style="padding-top: 0.12rem">60000</b>
                                                    <div class="w-8 mt-1 text-font"
                                                         style="margin-top: 0.25rem; margin-bottom: 0.35rem">
                                                        <CoinIcon/>
                                                    </div>
                        ...
                        <div class="pt-8 md:pt-14 lg:pb-6">
                            <h2 class="text-6xl text-center lg:text-left">
                                Season packs
                            </h2>
                            <div
